...
<div class="container" style="margin-top:60px;margin-bottom:60px;">
  <div style="max-width:520px;margin:0 auto;background:#fff;border-radius:20px;padding:60px 50px;box-shadow:0 8px 40px rgba(0,0,0,0.1);text-align:center;">
    ...
    <div style="font-size:72px;font-weight:800;background:linear-gradient(135deg,#667eea,#764ba2);-webkit-background-clip:text;-webkit-text-fill-color:transparent;line-height:1;margin-bottom:16px;">403</div>
